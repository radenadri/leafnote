    ...
    <main class="animate-fade-in">
      <section class="py-2">
        ...
        <template v-if="isSignedIn">
          ...
          <button
            ...
            @click="navigateTo('/')"
          >
            <UIcon name="i-lucide-log-in" class="w-5 h-5 text-destructive" />
        ...
        <div v-else class="px-4 py-3">
          <div class="p-4 bg-card rounded-lg border border-border/50">
            <div class="flex items-start gap-3 mb-4">
              <UIcon name="i-lucide-cloud" class="w-5 h-5 text-leaf-500 mt-0.5" />
              <div>
      ...
      <section class="py-2">
        ...
        <div class="flex items-center gap-3 px-4 py-3">
          <UIcon name="i-lucide-cloud" class="w-5 h-5 text-muted-foreground" />
        ...
        <div class="w-full flex items-center gap-3 px-4 py-3 transition-colors">
          <UIcon name="i-lucide-info" class="w-5 h-5 text-muted-foreground" />
      ...
      <section class="py-2">
        ...
        <div class="px-4 py-4">
          <div class="flex items-start gap-3 p-4 bg-leaf-50 rounded-lg">
            <UIcon name="i-lucide-shield" class="w-5 h-5 text-leaf-600 mt-0.5" />
            <div>
              <p class="text-sm font-medium text-foreground mb-1">
